...
private:
  ...
  //Ali's changes starts here March24
  ...
  //Ali's changes ends here March24
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1_Electron1DiJetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1_Muon1DiJetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1_Muon1IsZmm;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hMuon1PtVsElectron1Pt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1DeltaR;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1DeltaPtDivSumPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1DeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1_Muon1MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1_Electron1MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1OSLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1_Muon1MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1_Electron1MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hMuon1MetDeltaPhiVsMuon1Electron1CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1NotReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1ReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1PZeta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1PZetaVis;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hMuon1Electron1Zeta2D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1Zeta1D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron1DiJetReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2_Electron2DiJetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2_Muon1DiJetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2_Muon1IsZmm;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hMuon1PtVsElectron2Pt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2DeltaR;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2DeltaPtDivSumPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2DeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2_Muon1MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2_Electron2MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2OSLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2_Muon1MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2_Electron2MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hMuon1MetDeltaPhiVsMuon1Electron2CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2NotReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2ReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2PZeta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2PZetaVis;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hMuon1Electron2Zeta2D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2Zeta1D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Electron2DiJetReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1_Electron1DiJetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1_Muon2DiJetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1_Muon2IsZmm;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hMuon2PtVsElectron1Pt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1DeltaR;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1DeltaPtDivSumPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1DeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1_Muon2MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1_Electron1MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1OSLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1_Muon2MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1_Electron1MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hMuon2MetDeltaPhiVsMuon2Electron1CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1NotReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1ReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1PZeta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1PZetaVis;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hMuon2Electron1Zeta2D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1Zeta1D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron1DiJetReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2_Electron2DiJetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2_Muon2DiJetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2_Muon2IsZmm;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hMuon2PtVsElectron2Pt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2DeltaR;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2DeltaPtDivSumPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2DeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2_Muon2MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2_Electron2MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2OSLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2_Muon2MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2_Electron2MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hMuon2MetDeltaPhiVsMuon2Electron2CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2NotReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2ReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2PZeta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2PZetaVis;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hMuon2Electron2Zeta2D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2Zeta1D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Electron2DiJetReconstructableMass;
  //Ali's changes ends here March24
